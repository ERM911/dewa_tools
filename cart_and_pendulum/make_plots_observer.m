...
set(h(2),'LineWidth',2)
set(h(2),'Color',[0 1 0])
m(1) = plot(0,0,'ro','MarkerSize',10,'MarkerEdgeColor','k','MarkerFaceColor','r');
...
m(2) = plot(0,0,'ro','MarkerSize',10,'MarkerEdgeColor','k','MarkerFaceColor','r');
